...
async function displayPerson(req, res) {
    ...
    try {
        ...
        const person = await ngsiLD.readEntity(String(req.params.id), { options: 'keyValues' }, ngsiLD.setHeaders(req.session.access_token, LinkHeader));
