...
async function displaySoil(req, res) {
    ...
    try {
        ...
        const soil = await ngsiLD.readEntity(String(req.params.id), { options: 'keyValues' }, ngsiLD.setHeaders(req.session.access_token, LinkHeader));
