...
async function displayFarm(req, res) {
    ...
    try {
        ...
        const building = await ngsiLD.readEntity(String(req.params.id), { options: 'keyValues' }, ngsiLD.setHeaders(req.session.access_token, LinkHeader));
