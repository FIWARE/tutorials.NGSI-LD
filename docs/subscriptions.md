...
[NGSI-LD](https://cim.etsi.org/NGSI-LD/official/front-page.html) Subscribe/Notify paradigm and how to use NGSI
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?repo=FIWARE/tutorials.Subscriptions&ref=NGSI-LD)
...
[IoT Agent for JSON](https://fiware-iotagent-json.readthedocs.io/en/latest/). Usage of any NGSI-LD Context Broker is
