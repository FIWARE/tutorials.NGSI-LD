...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?repo=FIWARE/tutorials.Short-Term-History&ref=NGSI-LD)
...
[IoT Agent for JSON](https://fiware-iotagent-json.readthedocs.io/en/latest/). In addition, the optional temporal
