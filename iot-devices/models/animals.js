...
const STATUS = {
  AT_REST: {
    code: 0,
    heartRates: generateRange(COW_HEART_RATE, 2).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    temperatures: generateRange(COW_BODY_TEMPERATURE, 1).map((n) =>
      parseFloat(n.toFixed(2))
    ),
  ...
  DRINKING: {
    code: 5,
    heartRates: generateRange(COW_HEART_RATE + 0.5, 0.4).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    temperatures: generateRange(COW_BODY_TEMPERATURE + 0.2, 0.2).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    steps: generateRange(COW_AVERAGE_STEPS - 2, 1).map((n) =>
      Math.floor(n * 1000)
    ),
  ...
  GRAZING: {
    code: 6,
    heartRates: generateRange(COW_HEART_RATE - 1, 3).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    temperatures: generateRange(COW_BODY_TEMPERATURE - 0.1, 1).map((n) =>
      parseFloat(n.toFixed(2))
    ),
  ...
  MOVING: {
    code: 7,
    heartRates: generateRange(COW_HEART_RATE + 10, 2).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    temperatures: generateRange(COW_BODY_TEMPERATURE + 0.2, 2).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    steps: generateRange(COW_AVERAGE_STEPS + 2, 4).map((n) =>
      Math.floor(n * 1000)
    ),
  ...
  MOUNTING: {
    code: 9,
    heartRates: generateRange(COW_HEART_RATE + 3, 0.5).map((n) =>
      parseFloat(n.toFixed(2))
    ),
    temperatures: generateRange(COW_BODY_TEMPERATURE, 1).map((n) =>
      parseFloat(n.toFixed(2))
